...
import 'package:mxflutter_demo/biz_service_api_proxy.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          Expanded(
            ...
            children: <Widget>[
              ...
              ListTile(
                ...
                subtitle: Text('mxflutter-js-demo'),
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
              ...
              ListTile(
                leading: Icon(Icons.book),
                trailing: Icon(Icons.arrow_right),
                title: Text('ts init demo example1'),
                subtitle: Text('run ts example'),
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => MXJSPageWidget(
                              jsWidgetName: "example1", bizPath: '4320')));
                },
              ),
              ListTile(
                leading: Icon(Icons.book),
          ...
          Image.network(
            'https://pub.idqqimg.com/pc/misc/files/20210319/c54881a48c8847559bc80e1c1500dfe4.png',
            width: 260,
            height: 200,
          )
        ]));
